  ...
  createModal () {
    this._modal.innerHTML = `
        <h1 class="photographer-title photographer-title--modal" id="contact-title">
            ...
            <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg" role="button" aria-label="Fermer la modale de contact" class="close-modal close-modal--contact" data-name="contact"  tabindex="1">
